\hypertarget{em__idac_8c}{}\doxysection{gecko\+\_\+sdk\+\_\+3.2.1/platform/emlib/src/em\+\_\+idac.c File Reference}
\label{em__idac_8c}\index{gecko\_sdk\_3.2.1/platform/emlib/src/em\_idac.c@{gecko\_sdk\_3.2.1/platform/emlib/src/em\_idac.c}}


Current Digital to Analog Converter (IDAC) peripheral API.  


{\ttfamily \#include \char`\"{}em\+\_\+idac.\+h\char`\"{}}\newline


\doxysubsection{Detailed Description}
Current Digital to Analog Converter (IDAC) peripheral API. 

\hypertarget{em__idac_8c_autotoc_md26}{}\doxysubsection{License}\label{em__idac_8c_autotoc_md26}
