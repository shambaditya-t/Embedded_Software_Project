\hypertarget{em__ebi_8c}{}\doxysection{gecko\+\_\+sdk\+\_\+3.2.1/platform/emlib/src/em\+\_\+ebi.c File Reference}
\label{em__ebi_8c}\index{gecko\_sdk\_3.2.1/platform/emlib/src/em\_ebi.c@{gecko\_sdk\_3.2.1/platform/emlib/src/em\_ebi.c}}


External Bus Interface (EBI) Peripheral API.  


{\ttfamily \#include \char`\"{}em\+\_\+ebi.\+h\char`\"{}}\newline


\doxysubsection{Detailed Description}
External Bus Interface (EBI) Peripheral API. 

\hypertarget{em__ebi_8c_autotoc_md21}{}\doxysubsection{License}\label{em__ebi_8c_autotoc_md21}
