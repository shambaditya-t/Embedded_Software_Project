\hypertarget{em__vdac_8c}{}\doxysection{gecko\+\_\+sdk\+\_\+3.2.1/platform/emlib/src/em\+\_\+vdac.c File Reference}
\label{em__vdac_8c}\index{gecko\_sdk\_3.2.1/platform/emlib/src/em\_vdac.c@{gecko\_sdk\_3.2.1/platform/emlib/src/em\_vdac.c}}


Digital to Analog Converter (VDAC) Peripheral API.  


{\ttfamily \#include \char`\"{}em\+\_\+vdac.\+h\char`\"{}}\newline


\doxysubsection{Detailed Description}
Digital to Analog Converter (VDAC) Peripheral API. 

\hypertarget{em__vdac_8c_autotoc_md43}{}\doxysubsection{License}\label{em__vdac_8c_autotoc_md43}
