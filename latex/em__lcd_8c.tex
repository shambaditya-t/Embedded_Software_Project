\hypertarget{em__lcd_8c}{}\doxysection{gecko\+\_\+sdk\+\_\+3.2.1/platform/emlib/src/em\+\_\+lcd.c File Reference}
\label{em__lcd_8c}\index{gecko\_sdk\_3.2.1/platform/emlib/src/em\_lcd.c@{gecko\_sdk\_3.2.1/platform/emlib/src/em\_lcd.c}}


Liquid Crystal Display (LCD) Peripheral API.  


{\ttfamily \#include \char`\"{}em\+\_\+lcd.\+h\char`\"{}}\newline


\doxysubsection{Detailed Description}
Liquid Crystal Display (LCD) Peripheral API. 

\hypertarget{em__lcd_8c_autotoc_md27}{}\doxysubsection{License}\label{em__lcd_8c_autotoc_md27}
