\hypertarget{em__pcnt_8c}{}\doxysection{gecko\+\_\+sdk\+\_\+3.2.1/platform/emlib/src/em\+\_\+pcnt.c File Reference}
\label{em__pcnt_8c}\index{gecko\_sdk\_3.2.1/platform/emlib/src/em\_pcnt.c@{gecko\_sdk\_3.2.1/platform/emlib/src/em\_pcnt.c}}


Pulse Counter (PCNT) peripheral API.  


{\ttfamily \#include \char`\"{}em\+\_\+pcnt.\+h\char`\"{}}\newline


\doxysubsection{Detailed Description}
Pulse Counter (PCNT) peripheral API. 

\hypertarget{em__pcnt_8c_autotoc_md34}{}\doxysubsection{License}\label{em__pcnt_8c_autotoc_md34}
