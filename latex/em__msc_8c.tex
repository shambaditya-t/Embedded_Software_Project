\hypertarget{em__msc_8c}{}\doxysection{gecko\+\_\+sdk\+\_\+3.2.1/platform/emlib/src/em\+\_\+msc.c File Reference}
\label{em__msc_8c}\index{gecko\_sdk\_3.2.1/platform/emlib/src/em\_msc.c@{gecko\_sdk\_3.2.1/platform/emlib/src/em\_msc.c}}


Flash controller (MSC) Peripheral API.  


{\ttfamily \#include \char`\"{}em\+\_\+msc.\+h\char`\"{}}\newline


\doxysubsection{Detailed Description}
Flash controller (MSC) Peripheral API. 

\hypertarget{em__msc_8c_autotoc_md32}{}\doxysubsection{License}\label{em__msc_8c_autotoc_md32}
