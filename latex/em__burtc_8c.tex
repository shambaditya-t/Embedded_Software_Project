\hypertarget{em__burtc_8c}{}\doxysection{gecko\+\_\+sdk\+\_\+3.2.1/platform/emlib/src/em\+\_\+burtc.c File Reference}
\label{em__burtc_8c}\index{gecko\_sdk\_3.2.1/platform/emlib/src/em\_burtc.c@{gecko\_sdk\_3.2.1/platform/emlib/src/em\_burtc.c}}


Backup Real Time Counter (BURTC) Peripheral API.  


{\ttfamily \#include \char`\"{}em\+\_\+burtc.\+h\char`\"{}}\newline


\doxysubsection{Detailed Description}
Backup Real Time Counter (BURTC) Peripheral API. 

\hypertarget{em__burtc_8c_autotoc_md12}{}\doxysubsection{License}\label{em__burtc_8c_autotoc_md12}
