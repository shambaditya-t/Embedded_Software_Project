\hypertarget{em__ldma_8c}{}\doxysection{gecko\+\_\+sdk\+\_\+3.2.1/platform/emlib/src/em\+\_\+ldma.c File Reference}
\label{em__ldma_8c}\index{gecko\_sdk\_3.2.1/platform/emlib/src/em\_ldma.c@{gecko\_sdk\_3.2.1/platform/emlib/src/em\_ldma.c}}


Direct memory access (LDMA) module peripheral API.  


{\ttfamily \#include \char`\"{}em\+\_\+ldma.\+h\char`\"{}}\newline


\doxysubsection{Detailed Description}
Direct memory access (LDMA) module peripheral API. 

\hypertarget{em__ldma_8c_autotoc_md28}{}\doxysubsection{License}\label{em__ldma_8c_autotoc_md28}
