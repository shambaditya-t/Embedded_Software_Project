\hypertarget{em__csen_8c}{}\doxysection{gecko\+\_\+sdk\+\_\+3.2.1/platform/emlib/src/em\+\_\+csen.c File Reference}
\label{em__csen_8c}\index{gecko\_sdk\_3.2.1/platform/emlib/src/em\_csen.c@{gecko\_sdk\_3.2.1/platform/emlib/src/em\_csen.c}}


Capacitive Sense Module (CSEN) peripheral API.  


{\ttfamily \#include \char`\"{}em\+\_\+csen.\+h\char`\"{}}\newline


\doxysubsection{Detailed Description}
Capacitive Sense Module (CSEN) peripheral API. 

\hypertarget{em__csen_8c_autotoc_md17}{}\doxysubsection{License}\label{em__csen_8c_autotoc_md17}
