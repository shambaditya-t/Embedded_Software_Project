\hypertarget{em__iadc_8c}{}\doxysection{gecko\+\_\+sdk\+\_\+3.2.1/platform/emlib/src/em\+\_\+iadc.c File Reference}
\label{em__iadc_8c}\index{gecko\_sdk\_3.2.1/platform/emlib/src/em\_iadc.c@{gecko\_sdk\_3.2.1/platform/emlib/src/em\_iadc.c}}


Incremental Analog to Digital Converter (IADC) Peripheral API.  


{\ttfamily \#include \char`\"{}em\+\_\+iadc.\+h\char`\"{}}\newline


\doxysubsection{Detailed Description}
Incremental Analog to Digital Converter (IADC) Peripheral API. 

\hypertarget{em__iadc_8c_autotoc_md25}{}\doxysubsection{License}\label{em__iadc_8c_autotoc_md25}
